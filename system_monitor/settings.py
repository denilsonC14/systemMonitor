...
SECRET_KEY = 'django-insecure-sdu6^(&ynkqtslgb!wmd@&@hd(p@27_4$v^(boaoo-b+6_y^^6'
...
# Configuración para django-plotly-dash
...
MONITORING_THRESHOLDS = {
    'cpu_warning': 70,  # Porcentaje de CPU para advertencia
